...
At PearlThoughts, we prioritize learning and growth. Over the course of your internship, you will:

- Work closely with experienced developers
- Participate in exciting real-world projects
- Contribute to meaningful solutions that impact our clients and users
- Dive into essential technologies
- Engage in software development best practices

## Core Values

### 🎯 Learning First
We encourage you to ask questions, share ideas, and take full advantage of the resources available to you.

### 🤝 Collaboration
Work together with your team members, mentors, and peers to achieve common goals.

### 💡 Innovation
Bring fresh perspectives and creative solutions to challenges.
...
Focus on server-side development with NestJS, TypeScript, and PostgreSQL.

### Full Stack Developer Internship
Comprehensive experience with Next.js frontend and Nest.js backend development.

### AI Internship Program
Explore AI applications in business, machine learning, and data processing.
